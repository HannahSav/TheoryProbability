...
![formula](https://latex.codecogs.com/svg.image?\inline&space;С_100^5)  
  
_Количество случаев, когда мы выбираем 5 пригодных деталей -_
![formula](https://latex.codecogs.com/svg.image?\inline&space;С_95^5)  

_Вероятность:-_
![formula](https://latex.codecogs.com/svg.image?\inline&space;\frac{С_{95}^{5}}{C_{100}^{5}}=0,769589953)
